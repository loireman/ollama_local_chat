...
export default function CodeBlockLite({
    language,
    children,
}: {
    language: string;
    ...
    return (
        <div className="bg-[#272822] border-neutral-600 border rounded-xl overflow-visible pb-2 relative">
            <div className="bg-[#242329] px-2 py-4 w-full flex justify-between items-center rounded-t-xl">
